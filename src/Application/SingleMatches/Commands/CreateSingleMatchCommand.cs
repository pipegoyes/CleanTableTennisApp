...
public class CreateSingleMatchCommand : IRequest<bool>
{
    public int TeamMatchId { get; set; }
}

public class CreateSingleMatchHandler : IRequestHandler<CreateSingleMatchCommand, bool>
{
    private readonly IApplicationDbContext _context;

    public CreateSingleMatchHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<bool> Handle(CreateSingleMatchCommand request, CancellationToken cancellationToken)
    {
