...
namespace CleanTableTennisApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230512210519_AddScrore")]
    partial class AddScrore
    {
            ...
            modelBuilder.Entity("CleanTableTennisApp.Domain.Entities.DoubleMatch", b =>
                {
                    ...
                    b.Property<int>("GuestPlayerRigthId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanTableTennisApp.Domain.Entities.DoubleMatch", b =>
                {
                    ...
                    b.HasOne("CleanTableTennisApp.Domain.Entities.Player", "GuestPlayerRigth")
                        .WithMany()
                        .HasForeignKey("GuestPlayerRigthId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
