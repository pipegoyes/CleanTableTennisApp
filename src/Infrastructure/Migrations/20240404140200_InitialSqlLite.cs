        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    HostTeamId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    HostPlayerRightId = table.Column<int>(type: "INTEGER", nullable: false),
                    HostPlayerLeftId = table.Column<int>(type: "INTEGER", nullable: false),
                    GuestPlayerRightId = table.Column<int>(type: "INTEGER", nullable: false),
                    GuestPlayerLeftId = table.Column<int>(type: "INTEGER", nullable: false),
                    TeamMatchId = table.Column<int>(type: "INTEGER", nullable: false),
                    PlayingOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    Created = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: true),
                    LastModified = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "TEXT", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoubleMatches", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SingleMatches", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoubleMatchId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
