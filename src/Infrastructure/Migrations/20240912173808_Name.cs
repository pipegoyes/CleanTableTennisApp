    ...
    public partial class Name : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SingleMatchScore",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    GamePointsHost = table.Column<int>(type: "INTEGER", nullable: false),
                    GamePointsGuest = table.Column<int>(type: "INTEGER", nullable: false),
                    MatchId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SingleMatchScore", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SingleMatchScore_SingleMatches_MatchId",
                        column: x => x.MatchId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SingleMatchScore_MatchId",
                table: "SingleMatchScore",
                column: "MatchId");
        }
